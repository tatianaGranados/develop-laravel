<div wire:ignore.self class="modal fade" id="devolverGci" tabindex="-1" role="dialog" aria-labelledby="exampleModalLongTitle" aria-hidden="true">
                                    ...
                                    @forelse ($nro_prestamos as $nro)
                                        <tr style="font-size: 13px;">
                                            ...
                                            <td class="td-actions text-center">
                                                <a href="{{ route('prestarGci', ['id' => $nro->id_agrupado]) }}" class="btn btn-warning" target="_blanck"><span class="material-icons">print</span></a>  
                                            </td>
                                        </tr> 
                                    @empty
                                        <tr>
