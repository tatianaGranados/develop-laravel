...
<div class="table-responsive">
    <table class="table table-striped table-bordered table-hover table-condensed">
        ...
        <tbody>
            ...
            <th colspan="3" class="text-center table-success no-padding">REPORTE CAJA A ALMACEN</th>
            @foreach( $reporteCaja as $enlace)
                <tr>
                    <td class="text-center no-padding" >{{ $enlace->id }}</td>
                    <td class="no-padding">
                        <span class="material-icons">{{ $enlace->icono }}</span>
            ...
            <th colspan="3" class="text-center table-success no-padding">ARCHIVADO DE COMPROBANTES</th>
            @foreach( $archivarComp as $enlace)
                <tr>
                    <td class="text-center no-padding" >{{ $enlace->id }}</td>
                    <td class="no-padding">
                        <span class="material-icons">{{ $enlace->icono }}</span>
            ...
            <th colspan="3" class="text-center table-success no-padding">PRESTAMOS DEVOLUCIONES</th>
            @foreach( $prestamosDevoluc as $enlace)
                <tr>
                    <td class="text-center no-padding" >{{ $enlace->id }}</td>
                    <td class="no-padding">
                        <span class="material-icons">{{ $enlace->icono }}</span>
