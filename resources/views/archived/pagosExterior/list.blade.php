<div>
	...
	<div class="text-center container">
		<button type="button" class="btn btn-info" data-toggle="modal" data-target="#createTomoPe">
	...
	<div class="table-responsive">
		<table class="table table-condensed table-bordered table-striped">
			<thead class="text-center">
				<tr class="table-info">
					<th style="font-size: 13px;"><strong>Nro Comprobante</strong></th>
					<th style="font-size: 13px;"><strong>Nro Preventivo </strong></th>
                ...
                @forelse ($gastos as $gasto)
					<tr style="font-size: 13px;">
						...
						<td class="text-center">
							<input style="width: 18px; height: 18px;" type="checkbox" value="{{ $gasto->id }}" id="{{ $gasto->id }}" wire:model="agrupadoPe">
						</td>
					</tr>
				@empty
					<tr>
