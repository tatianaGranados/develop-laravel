<div wire:ignore.self class="modal fade" id="createTomoGci" tabindex="-1" role="dialog" aria-labelledby="exampleModalLongTitle" aria-hidden="true">
                    ...
                    <form wire:submit.prevent="store">
                        ...
                        <div class="form_group row form-blue">
                            <div class="form-group col-md-6">
                                ...
                                <input type="text" class="form-control" id="tomo" placeholder="ingrese nro tomo" name="tomo" wire:model="tomo">
                                @error('tomo')
