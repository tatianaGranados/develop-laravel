<div>
	...
	@if(in_array(26, $permisos))
		<div class="text-right container">
			<button type="button" class="btn btn-info" data-toggle="modal" data-target="#createPe">
				<span class="material-icons">note_add</span> Crear Nuevo Pago Exterior
			</button>	
		</div>
		@include('pagosExterior.create')
	@endif
